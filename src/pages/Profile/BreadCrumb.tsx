export default function BreadCrumb({activeMenu}:{activeMenu:string}) {
    return (
        <div className="flex flex-wrap items-center space-x-2 text-sm text-gray-500 font-medium mb-5">
            ...
            <a href="#" className="text-indigo-500">{activeMenu}</a>
        </div>
    );
};